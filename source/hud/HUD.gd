...
func initialize(healthAttribute : Attribute, skillSet : SkillSet, statusEffectManager : StatusEffectManager) -> void:
...
func initializeHealhBar(healthAttribute : Attribute) -> void:
	_healthBar.initialize(healthAttribute.getMaxValue(), healthAttribute.getValue())
